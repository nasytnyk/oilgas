...
/// метриці (одиниця, фізичні межі, точність, алармові пороги). Джерело правди прямо в коді.
/// Per-device тюнінг (baseline/noise/spike) тут НЕ живе — це профіль пристрою (MeasurementProfile).
/// На дріт/у БД мандрує як <see cref="Wire"/> (snake_case).
/// </summary>
public sealed class Measurement
{
    public static readonly Measurement IntakePressure =
        new(nameof(IntakePressure), Unit.Bar, floor: 0, ceiling: 500, decimals: 1, warning: new(Max: 120), critical: new(Max: 150));
    public static readonly Measurement MotorTemp =
        new(nameof(MotorTemp), Unit.Celsius, floor: 0, ceiling: 250, decimals: 1, warning: new(Max: 110), critical: new(Max: 130));
    public static readonly Measurement Vibration =
        new(nameof(Vibration), Unit.MillimetrePerSecond, floor: 0, ceiling: 50, decimals: 2, warning: new(Max: 7), critical: new(Max: 11));
    ...
    public static readonly Measurement TubingPressure =
        new(nameof(TubingPressure), Unit.Bar, floor: 0, ceiling: 700, decimals: 1, warning: new(Max: 220), critical: new(Max: 260));
    public static readonly Measurement CasingPressure =
        new(nameof(CasingPressure), Unit.Bar, floor: 0, ceiling: 500, decimals: 1, warning: new(Max: 140), critical: new(Max: 170));
    public static readonly Measurement Temperature =
        new(nameof(Temperature), Unit.Celsius, floor: -50, ceiling: 300, decimals: 1, warning: new(Max: 120), critical: new(Max: 150));
    public static readonly Measurement Pressure =
        new(nameof(Pressure), Unit.Bar, floor: 0, ceiling: 100, decimals: 1, warning: new(Max: 20), critical: new(Max: 25));
    public static readonly Measurement Level =
        new(nameof(Level), Unit.Percent, floor: 0, ceiling: 100, decimals: 1, warning: new(Min: 20, Max: 90), critical: new(Min: 10, Max: 95));
    ...
    public static readonly Measurement DischargePressure =
        new(nameof(DischargePressure), Unit.Bar, floor: 0, ceiling: 300, decimals: 1, warning: new(Max: 60), critical: new(Max: 75));
