...
public static class HardwareRoster
{
    ...
    [
        new("esp-001", DeviceType.EspPump, Field.North, Well.W12,
        [
        ...
        new("wh-001", DeviceType.Wellhead, Field.North, Well.W12,
        [
